...
declare class ConnectedAccounts {
   ...
   * ```
   */
  update(nanoid: string, params: UpdateConnectedAccountParams): Promise<ConnectedAccountPatchResponse>;
}
//#endregion
